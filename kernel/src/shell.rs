...
fn cmd_help() {
    println!("NodeAI Shell — type 'help <topic>' for details");
    println!("");
    println!("  Navigation:   cd, pwd, ls");
    println!("  Files:        cat, touch, mkdir, rm, cp, mv, head, tail");
    println!("  Text:         grep, echo, sort, diff, xxd");
    println!("  System:       free, ps, kill, top, uptime, uname, date, dmesg");
    println!("  Process:      nice, bg, fg, jobs, nohup");
    println!("  Network:      ifconfig, ping, netstat, ip, curl, wget");
